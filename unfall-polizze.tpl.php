<?php $date_anlage = date_create($userdata['userdata']['datAbschluss']); ?>
<pre><?php // print_r($polizze); ?></pre>
<h3>angelio schützt Dich weltweit im Beruf und in der Freizeit, 24 Stunden</h3>

<p></p><b>Versicherungsbest&auml;tigungsnummer:</b> <?php print $userdata['userdata']['Polizzennummer']; ?></p>
<p></p><b>Produkt:</b> <?php print $userdata['userdata']['strProduktbeschreibung']; ?></p>
...
<table>
<tr><td><b>Mitgliedsnummer:</b></td><td><?php print $userdata['userdata']['KundenID_online']; ?></td></tr>
<tr><td><b>Name:</b></td><td><?php print $userdata['userdata']['strTitel_O'] . " " . $userdata['userdata']['strVName_O'] . " " . $userdata['userdata']['strNName_O']; ?></td></tr>
<tr><td><b>Geburtsdatum:</b></td><td><?php print date_format(date_create($userdata['userdata']['datGeburt_O']), 'd.m.Y'); ?></td></tr>
<tr><td><b>Adresse:</b></td><td><?php print $userdata['userdata']['strAnschrift_O'] . ", " . $userdata['userdata']['strPLZ_O'] . " " . $userdata['userdata']['strOrt_O'] . ", " . $userdata['userdata']['strLand_O']; ?></td></tr>
<tr><td><b>Beruf:</b></td><td><?php print $userdata['userdata']['strBeruf_O']; ?></td></tr>
</table>
...
<p>Vorchdorf, am <?php print date_format(date_create($userdata['userdata']['datAbschluss']), 'd.m.Y'); ?></p>
...
<p><a href="/print/polizze/<?php print $userdata['userdata']['KundenID_online']; ?>/<?php print $userdata['userdata']['Polizzennummer_O']; ?>" target="_blank">Druckversion</a>&nbsp;|&nbsp;<a href="/pdf/polizze/<?php print $userdata['userdata']['KundenID_online']; ?>/<?php print $userdata['userdata']['Polizzennummer_O']; ?>" target="_blank">PDF Drucken</a></p>
